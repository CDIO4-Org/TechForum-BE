...
public class EmailRegister {
    ...
    public void sendEmailReport(Users users, Blogs blogs, String report, LocalDate date) throws MessagingException {
        MimeMessage mimeMessage = mailSender.createMimeMessage();
        MimeMessageHelper mimeMessageHelper = new MimeMessageHelper(mimeMessage, "UTF-8");
        ...
        // Render template thành chuỗi HTML
        String htmlContent = templateEngine.process("Report", context); // Tên template không cần phần mở rộng
