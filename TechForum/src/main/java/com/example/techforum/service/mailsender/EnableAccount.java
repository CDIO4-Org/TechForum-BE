...
public class EnableAccount {
    ...
    public void sendEmailEnableAccount(String email, String accountName) throws MessagingException {
        ...
        String htmlContent = templateEngine.process("EnableAccount", context); // Tên template không cần phần mở rộng

        // Thiết lập email với nội dung HTML
        mimeMessageHelper.setTo(email);
        mimeMessageHelper.setSubject("Thông báo kích hoạt tài khoản");
